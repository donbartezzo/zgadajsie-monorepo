...
| #   | Kwestia                                 | Decyzja                                                                                                                                                                                                                                                                                                                                                                      |
| --- | --------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| B1  | Reguła `isTrusted` / lista oczekujących | **Pełna normalność.** Fake user przechodzi `isTrusted` jak realny: u nieznanego organizatora ląduje na liście oczekujących (`waitingReason = NOT_TRUSTED`) i czeka na ręczne zatwierdzenie. Po pierwszym zatwierdzeniu auto-trust (działa dla `addedByUserId = null`, czyli także dla fake usera) sprawia, że kolejne wydarzenia tego samego organizatora dają slot od razu. |
