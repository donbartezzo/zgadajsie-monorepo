  ...
  template: `
    ...
    >
      <div class="w-full max-w-sm">
        <div
          class="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-yellow-50 dark:bg-yellow-900/20"
        >
          <app-icon name="mail" class="text-yellow-500 dark:text-yellow-400" size="lg"></app-icon>
        </div>
