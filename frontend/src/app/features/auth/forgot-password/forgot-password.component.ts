      ...
      <app-card>
        <div class="p-6">
          <div class="text-center mb-6">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Podaj email powiązany z Twoim kontem</p>
          </div>
          ...
          @if (sent()) {
            <div class="text-center">
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Link do resetowania hasła został wysłany na podany adres email.</p>
