...
describe('EventFormComponent', () => {
  ...
  describe('flaga intencji serii', () => {
    ...
    it('gdy createSeriesIntent = false, wywołuje createEvent i redirect do detail', fakeAsync(() => {
      mockEventService.createEvent.mockReturnValue(
    ...
    it('gdy createSeriesIntent = true, wywołuje createEvent i redirect do create-series', fakeAsync(() => {
      mockEventService.createEvent.mockReturnValue(
        of({ id: 'ev1', city: { slug: 'warsaw' } } as unknown as Record<string, unknown>),
      );
      ...
      fillValidEventForm();
      component.createSeriesIntent.set(true);
      component.onSubmit();
      tick();

      expect(mockEventService.createEvent).toHaveBeenCalled();
      expect(navSpy).toHaveBeenCalledWith('/o/w/ev1/create-series');
    }));

    it('gdy createSeriesIntent = true w trybie edycji, wywołuje updateEvent i redirect do detail', fakeAsync(() => {
