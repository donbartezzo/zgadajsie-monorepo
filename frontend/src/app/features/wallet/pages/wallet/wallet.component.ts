        ...
        <div class="p-6 text-center">
          ...
          <div class="mt-4">
            ...
            <div class="flex gap-2 items-center justify-center">
              ...
              />
              <app-button variant="primary" [loading]="topupLoading()" (clicked)="onTopup()"
                >Zapłać</app-button
              >
          ...
          <div class="p-3 flex items-center justify-between">
            <div>
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400">
                {{ t.createdAt | date : 'd MMM yyyy, HH:mm' }}
              </p>
              @if (t.relatedEvent) {
              <a
                [routerLink]="['/events', t.relatedEvent.id]"
                class="text-xs text-highlight dark:text-highlight-light hover:underline"
                >{{ t.relatedEvent.title }}</a
              >
              }
            </div>
            <span
