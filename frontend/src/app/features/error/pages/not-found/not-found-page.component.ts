  ...
  template: `
    ...
    >
      <div class="w-full max-w-sm">
        <div
          class="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-gray-100 dark:bg-slate-700"
        >
          <app-icon name="search" class="text-gray-400 dark:text-gray-500" size="lg"></app-icon>
        </div>
