...
@Component({
 ...
 <div class="space-y-4">
 <div class="w-16 h-16 mx-auto rounded-full bg-success-50 flex items-center justify-center">
 ...
 @let _payment = payment();
 <div class="space-y-4">
 <div class="w-16 h-16 mx-auto rounded-full bg-danger-50 flex items-center justify-center">
 ...
 @case ('pending') {
 <div class="space-y-4">
 <div class="w-16 h-16 mx-auto rounded-full bg-warning-50 flex items-center justify-center">
 ...
 @case ('not_found') {
 <div class="space-y-4">
 <div class="w-16 h-16 mx-auto rounded-full bg-neutral-100 flex items-center justify-center">
