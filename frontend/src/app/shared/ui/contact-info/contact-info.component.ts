        ...
        <div class="space-y-2 text-sm">
          ...
          <div class="pt-3 mt-3 border-t border-gray-200 dark:border-gray-700">
            <a
              ...
              [ngClass]="{
                'bg-green-600 hover:bg-green-700 text-white': variant() === 'green',
                'bg-blue-600 hover:bg-blue-700 text-white': variant() === 'blue',
                'bg-purple-600 hover:bg-purple-700 text-white': variant() === 'purple'
              }"
            >
