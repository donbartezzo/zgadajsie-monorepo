        ...
        @switch (name()) {
          ...
          @case ('help') {
            <g transform="scale(1.4) translate(-3.5, -3.5)">
              <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" stroke-width="2.5" />
          ...
          @case ('hanger') {
            <path
              d="M20 7h-7L10 2a2 2 0 0 0-3-1 2 2 0 0 0-1 3l5 5v7a2 2 0 0 0 2 2h7a2 2 0 0 0 2-2v-7l5-5a2 2 0 0 0-1-3 2 2 0 0 0-3 1l-3 5z"
            />
          ...
          @case ('ball') {
            <circle cx="12" cy="12" r="10" />
            <path
              d="M12 2a10 10 0 0 0-8.66 5h17.32A10 10 0 0 0 12 2z"
              fill="currentColor"
              opacity="0.3"
            />
            <path
              d="M12 22a10 10 0 0 0 8.66-5H3.34A10 10 0 0 0 12 22z"
              fill="currentColor"
              opacity="0.3"
            />
            <line
...
export class IconComponent {
  ...
  readonly muted = input<Muted | null>(null);
  ...
  readonly colorClass = computed(() => {
    ...
    // Jeśli kolor nie został jawnie ustawiony (domyślny 'neutral'), nie nadpisuj koloru
    // - pozwól dziedziczeniu przez currentColor
    const colorInput = this.color();
    if (colorInput === 'neutral' && !this.muted()) {
      return '';
    }
