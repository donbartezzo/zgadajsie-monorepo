  ...
  template: `
    ...
    <div class="relative my-6">
      ...
      <div class="relative flex justify-center text-xs">
        <span class="bg-white dark:bg-slate-800 px-2 text-gray-500 dark:text-gray-400">lub</span>
      </div>
    </div>
    ...
    <div class="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
      ...
      <a
        ...
        class="text-highlight dark:text-highlight-light font-medium hover:underline"
        >Zarejestruj się</a
      >
    </div>
  `,
