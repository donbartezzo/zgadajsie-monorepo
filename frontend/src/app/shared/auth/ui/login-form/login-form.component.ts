...
@Component({
  ...
  template: `
    <form (ngSubmit)="onSubmit()" class="space-y-4">
      <div>
        <label for="login-email" class="block text-sm font-medium text-neutral-700 mb-1"
          >Email</label
        >
        <input
          id="login-email"
      ...
      <div>
        <label for="login-password" class="block text-sm font-medium text-neutral-700 mb-1"
          >Hasło</label
        >
        <div class="relative">
          <input
    ...
    <div class="relative my-6">
      ...
      <div class="relative flex justify-center text-xs">
        <span class="bg-white px-2 text-neutral-500">lub</span>
      </div>
    </div>
    ...
    <div class="mt-6 text-center text-sm text-neutral-500">
      Nie masz konta?
      <a routerLink="/auth/register" class="text-primary-500 font-medium hover:underline"
        >Zarejestruj się</a
      >
    </div>
  `,
